...
public class MariadbPrimaryPdbDependentResource extends CRUDKubernetesDependentResource<PodDisruptionBudget, SconeOsvScanner> {

    public MariadbPrimaryPdbDependentResource() {
    ...
    protected PodDisruptionBudget desired(SconeOsvScanner primary, Context<SconeOsvScanner> context) {
        ...
        String name = Constants.getMariadbPrimaryName(primaryName) + "-pdb";
