...
public class MariadbPrimaryServiceDependentResource extends AbstractMariadbServiceDependentResource {

    @Override
    protected String getServiceName(String primaryName) {
        return Constants.getMariadbPrimaryServiceName(primaryName);
    }
