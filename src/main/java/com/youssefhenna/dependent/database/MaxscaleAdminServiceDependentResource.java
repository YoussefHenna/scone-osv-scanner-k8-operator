...
public class MaxscaleAdminServiceDependentResource extends CRUDKubernetesDependentResource<Service, SconeOsvScanner> {

    public MaxscaleAdminServiceDependentResource() {
        super(Service.class);
    }
    ...
    protected Service desired(SconeOsvScanner primary, Context<SconeOsvScanner> context) {
        ...
        String name = Constants.getMaxscaleAdminServiceName(primaryName);
