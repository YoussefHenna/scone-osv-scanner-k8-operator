...
public class MariadbPrimaryImageValidatingPolicyDependentResource extends AbstractImageValidatingPolicyDependentResource {
    ...
    protected String getPolicyName(String primaryName) {
        return Constants.getMariadbPrimaryImageValidatingPolicyName(primaryName);
    }
